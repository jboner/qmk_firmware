...
#define SFT_A       SFT_T(KC_A)                 // Tap for A, hold for Shift
#define SFT_S       SFT_T(KC_S)                 // Tap for S, hold for Shift
...
#define GUI_S       GUI_T(KC_S)                 // Tap for S, hold for GUI
#define GUI_A       GUI_T(KC_A)                 // Tap for A, hold for GUI
#define ALT_MIN     ALT_T(KC_MINS)              // Tap for -, hold for ALT

#define TC_A        LT(_TOUCHCURSOR, KC_A)      // Touch Cursor or A
#define TC_S        LT(_TOUCHCURSOR, KC_S)      // Touch Cursor or S


// Requires KC_TRNS/_______ for the trigger key in the destination layer
#define TC_SPC      LT(_TOUCHCURSOR, KC_SPC)    // Tap for Space, hold for TouchCursor
#define TC_U        LT(_TOUCHCURSOR, KC_U)      // Tap for U, hold for TouchCursor
...
#define SFT_SLSH    M(KC_SFT_SLSH)              // Macro for Sft-Slash (i.e. ?)
 ...
 * |   "  |   ,  |   .  |   P  |   Y  |      |      |   F  |   G  |   C  |   R  |   L  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |SFT/A |   O  |   E  | TC/U |   I  | ESC  | -/_  |   D  |   H  |   T  |   N  |SFT/S |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   ;  |   Q  |   J  |   K  |   X  | PGUP | PGDW |   B  |   M  |   W  |   V  |   Z  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ALT  | CTRL | GUI  |LOWER |SHIFT | GUI  | TAB  |TC/SPC|RAISE | VoL- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_DVORAK] = {
  {KC_QUOT, KC_COMM, KC_DOT,  KC_P,  KC_Y,   _______, _______, KC_F,   KC_G,  KC_C,    KC_R,    KC_L},
  {SFT_A,   KC_O,    KC_E,    TC_U,  KC_I,   KC_ESC,  KC_MINS, KC_D,   KC_H,  KC_T,    KC_N,    SFT_S},
  {KC_SCLN, KC_Q,    KC_J,    KC_K,  KC_X,   KC_PGUP, KC_PGDN, KC_B,   KC_M,  KC_W,    KC_V,    KC_Z},
  {KC_LALT, KC_LCTL, KC_LGUI, LOWER, KC_LSFT, KC_LGUI, KC_TAB, TC_SPC, RAISE, KC_VOLD, KC_VOLU, KC_MPLY}
},
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      | DEL  | BSPC |  ENT |      | Prev | Next |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = {
  {KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, S(KC_SLSH)},
  {KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   _______, KC_GRV,  KC_PLUS, KC_LCBR, KC_RCBR, KC_SLSH},
  {KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS},
  {_______, _______, _______, _______, _______, _______, KC_DEL,  KC_BSPC, KC_ENT, _______, KC_MPRV, KC_MNXT}
},
...
[_RAISE] = {
  ...
  {KC_4,    KC_5,    KC_6,    KC_COMM, _______, _______, _______, KC_MINS, KC_PLUS, KC_ASTR, KC_SLSH, KC_PIPE},
  {KC_7,    KC_8,    KC_9,    KC_DOT,  _______, _______, _______, _______, KC_EQL,  _______, _______, _______},
  {BACKLIT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
},

/* TouchCursor
 * ,-----------------------------------------------------------------------------------.
 * | Find |AltTab|CtlTab|CmdTab|  ~   |      |      |Insert| Home |  Up  | End  | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  |Shift |Enter |      |      | PgUp | Left | Down |Right |Desk_L|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Undo | Paste| Cut  | Copy |  `   |      |      | PgDn | Copy | Cut  |Paste | Undo |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_TOUCHCURSOR] = {
  {AG_FIND, ALT_TAB, CTL_TAB, CMD_TAB,  KC_TILD,  _______, _______, KC_INS,  KC_HOME, KC_UP,   KC_END,   KC_BSPC},
  {KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT,  KC_ENT,   _______, _______, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT,  AG_D_L},
  {AG_UNDO, AG_PASTE,  AG_CUT, AG_COPY, KC_GRV,   _______, _______, KC_PGDN, AG_COPY, AG_CUT,  AG_PASTE, AG_UNDO},
  {_______, _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______,  _______}
},

/* MouseCursor
 * ,-----------------------------------------------------------------------------------.
 * |      |ACCL0 |ACCL1 |ACCL2 |      |      |      |      |WHL_L |  Up  |WHL_R |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      | BTN2 | BTN1 |      |      |      |WHL_Up| Left | Down |Right |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |WHL_Dn| BTN1 | BTN2 | BTN3 | BTN4 |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_MOUSECURSOR] = {
  {_______, KC_ACL0, KC_ACL1, KC_ACL2, _______, _______, _______, _______, KC_WH_L, KC_MS_U, KC_WH_R, _______},
  {_______, _______, KC_BTN2, KC_BTN1, _______, _______, _______, KC_WH_U, KC_MS_L, KC_MS_D, KC_MS_R, _______},
  {_______, _______, _______, _______, _______, _______, _______, KC_WH_D, KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
},
 ...
 * |   Q  |   W  |   E  |   R  |   T  |      |      |   Y  |   U  |   I  |   O  |   P  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | TC/A |   S  | MC/D |   F  |   G  | ESC  |  "   |   H  |   J  |   K  |   L  |  ;   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   Z  |   X  |   C  |   V  |   B  | PGUP | PGDW |   N  |   M  |   ,  |   .  |  /   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ALT  | CTRL | GUI  |LOWER |SHIFT | GUI  | TAB  |TC/SPC|RAISE | VoL- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {TC_A,    KC_S, LT_MC(KC_D),KC_F,  KC_G,    KC_ENT,  KC_QUOT, KC_H,   KC_J,  KC_K,    KC_L,    GUI_SEM},
  {KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,    KC_PGUP, KC_PGDN, KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH},
  {KC_LALT, KC_LCTL, KC_LGUI, LOWER, KC_LSFT, KC_LGUI, KC_TAB,  TC_SPC, RAISE, KC_VOLD, KC_VOLU, KC_MPLY}
},
...
[_COLEMAK] = {
  ...
  {KC_PSCR, KC_RGUI, KC_LALT, KC_LGUI, LOWER,   TC_SPC,  TC_SPC,   RAISE,   KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
 ...
 */
[_ADJUST] = {
  {_______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, QWERTY,  DVORAK},
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt)
{
    ...
    switch (id) {
      ...
      // emits a ? key code
      case KC_SFT_SLSH:
        return (record->event.pressed ? MACRO( D(LSFT),  D(SLSH),END ) : MACRO( U(SLSH),END ));
