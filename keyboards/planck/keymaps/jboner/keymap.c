 ...
 * |----------+------+------+------+------+-------------+------+------+------+------+--------|
 * | GUI/Esc  |   A  |   O  | MC/E |   U  |   I  |   D  |   H  |   T  |   N  |GUI/S |  Alt/- |
 * |----------+------+------+------+------+------|------+------+------+------+------+--------|
 * | Shift    |   ;  |   Q  |   J  |   K  |   X  |   B  |   M  |   W  |   V  |   Z  |  Enter |
 * |----------+------+------+------+------+------+------+------+------+------+------+--------|
 * | PrntScrn | Ctrl | Alt  | GUI  |Lower |  TC/Space   |Raise | Next | Vol- | Vol+ |  Play  |
 * `-----------------------------------------------------------------------------------------'
 */
[_DVORAK] = {
  {KC_TAB, KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,    KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_BSPC},
  {GUI_ESC, KC_A,    KC_O, LT_MC(KC_E),KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_MINS},
  {KC_LSPO, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_RSFT},
  {KC_PSCR, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   LT_TC,   LT_TC,   RAISE,   KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
...
[_LOWER] = {
  ...
  {KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_DEL,  KC_BSPC, KC_PLUS, KC_LCBR, KC_RCBR, KC_SLSH},
  {KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_ENT,  KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS},
 ...
 */
[_RAISE] = {
  {KC_0,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV},
  {KC_DLR,  KC_4,    KC_5,    KC_6,    KC_COMM, _______, _______, KC_PLUS, KC_MINS, KC_ASTR, KC_SLSH, KC_PIPE},
  {KC_EQL,  KC_7,    KC_8,    KC_9,    KC_DOT,  _______, _______, _______, _______, _______, _______, _______},
  {BACKLIT, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MSTP, KC_MSEL, KC_MUTE}
},

/* TouchCursor
 * ,-----------------------------------------------------------------------------------.
 * |Tab_C | Find |AltTab|CtlTab|CmdTab|  ~   |Insert| Home |  Up  | End  | Bksp |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      | Ctrl | GUI  | Alt  |Shift |Again | PgUp | Left | Down |Right |Desk_L|Desk_R|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 ...
 */
[_TOUCHCURSOR] = {
  {AG_T_C , AG_FIND, ALT_TAB, CTL_TAB, CMD_TAB, KC_TILD, KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_BSPC, _______},
  {_______, KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, AG_AGAIN, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, AG_D_L, AG_D_R },
 ...
 * |----------+------+------+------+------+-------------+------+------+------+------+--------|
 * | GUI/Esc  |   A  |   S  | MC/D |   F  |   G  |   H  |   J  |   K  |   L  |GUI/; | Alt/"  |
 * |----------+------+------+------+------+------|------+------+------+------+------+--------|
...
[_QWERTY] = {
  ...
  {GUI_ESC, KC_A,    KC_S, LT_MC(KC_D),KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    GUI_SEM, ALT_QUO},
